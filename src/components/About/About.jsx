        ...
        <div>
            <div className="container-about">
                ...
                <div className="about-sujet">
                    ...
                    <p>Restez connecté avec Focaly ! Suivez-nous sur nos réseaux sociaux pour découvrir nos nouveautés, des conseils, et partager vos expériences avec la communauté. <br /><br />Retrouvez-nous sur : <br /> Facebook, Instagram, Twitter.</p>
                </div>
